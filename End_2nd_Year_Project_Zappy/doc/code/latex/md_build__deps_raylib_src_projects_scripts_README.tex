Here are dependency-\/less build scripts for raylib projects.\hypertarget{md_build__deps_raylib_src_projects_scripts_README_autotoc_md79}{}\doxysubsection{Dependencies}\label{md_build__deps_raylib_src_projects_scripts_README_autotoc_md79}
The scripts, as mentioned above, do not have dependencies. There\textquotesingle{}s one exception to this however, and that is Windows, because Windows doesn\textquotesingle{}t have a built-\/in C compiler. On Windows, you\textquotesingle{}ll need to install \href{https://visualstudio.microsoft.com/downloads/\#visual-studio-community-2017}{\texttt{ Visual Studio}} or the \href{https://visualstudio.microsoft.com/downloads/\#build-tools-for-visual-studio-2017}{\texttt{ build tools}}. If you didn\textquotesingle{}t install them in the default location, write your changes around line 38 of \href{build-windows.bat}{\texttt{ {\ttfamily build-\/windows.\+bat}}}.\hypertarget{md_build__deps_raylib_src_projects_scripts_README_autotoc_md80}{}\doxysubsection{Script customization}\label{md_build__deps_raylib_src_projects_scripts_README_autotoc_md80}
...
\end{DoxyItemize}\hypertarget{md_build__deps_raylib_src_projects_scripts_README_autotoc_md81}{}\doxysubsection{Compilation flags}\label{md_build__deps_raylib_src_projects_scripts_README_autotoc_md81}
...
\end{DoxyItemize}\hypertarget{md_build__deps_raylib_src_projects_scripts_README_autotoc_md82}{}\doxysubsection{Command line arguments}\label{md_build__deps_raylib_src_projects_scripts_README_autotoc_md82}
...
\end{DoxyItemize}\hypertarget{md_build__deps_raylib_src_projects_scripts_README_autotoc_md83}{}\doxyparagraph{Examples}\label{md_build__deps_raylib_src_projects_scripts_README_autotoc_md83}
\tabulinesep=1mm
